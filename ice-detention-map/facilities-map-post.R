# facilities-map-post.R
# Adapted from ice-detention/facilities-map.R for use in Quarto post.
# Reads data from local RDS files (copied by copy-data.sh) instead of targets.
...
facility_presence        <- readRDS("data/facility_presence.rds")
facilities_panel         <- readRDS("data/facilities_panel.rds")
